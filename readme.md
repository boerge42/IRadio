...
* ein [1,77"-TFT-Display](https://cdn.shopify.com/s/files/1/1509/1638/files/1_77_Zoll_SPI_TFT_Display_Datenblatt_AZ-Delivery_Vertriebs_GmbH_0eab71a3-f0c9-42af-8089-d8e6f689e9dc.pdf?v=1606166813) bzw. ein 2.8 Zoll TFT-Display (ILI9341; 240x320 Pixel), ohne Touch, weil...
...
Hier ein Bild des Testaufbaues ([128x160-Version --> iradio.py](https://github.com/boerge42/IRadio/blob/main/iradio.py)):

<img src="pictures/testaufbau.png" width="500"/>


Die "Firmware", also mehr die Bedienoberfläche, wurde in Python implementiert. Natürlich wurden dabei die Vorteile einer funktionierenden Linux-Umgebung ausgenutzt. Für eine ausführliche Dokumentation wird auf den [Quelltext](https://github.com/boerge42/IRadio/blob/main/iradio.py) des Python-Scripts verwiesen!

Hier einige Bildschirminhalte ([128x160-Version](https://github.com/boerge42/IRadio/blob/main/iradio.py)) in den unterschiedlichen Situationen:
...
Das Python-Script [iradio_240x320.py](https://github.com/boerge42/IRadio/blob/main/iradio_240x320.py) ist eine Version, welche für eine Bildschirmauflösung von 240x320 Pixel (und einen Display-Controller ILI9341) optimiert wurde. Es passen hier mehr (bzw. ausführlichere) Informationen auf das Display. Die Bildschirminhalte sind analog zur [128x160-Pixel-Version](https://github.com/boerge42/IRadio/blob/main/iradio.py), aber an entsprechenden Stellen besser kommentiert bzw.angepasst.
